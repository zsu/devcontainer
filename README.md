...
Run `scripts/setup.sh` on the Ubuntu host to install Docker, DevPod, and all required tools. Use `source` so the SSH agent environment is applied to your current shell:
